  ...
  return (
    <div className="rounded-3xl border border-border/80 bg-card p-6 md:p-8 shadow-xl flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 font-sans">
      <div className="flex items-start gap-4">
        <div className="h-12 w-12 rounded-2xl bg-[#F26522]/10 border border-[#F26522]/20 flex items-center justify-center shrink-0 text-[#F26522] shadow-xs">
        ...
        {subscribed ? (
          ...
          >
            <input
              ...
              className="h-12 px-4 rounded-2xl border border-border/80 bg-background text-xs text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-[#F26522]/40 w-full sm:w-72 font-medium"
            />
            <button
              type="submit"
              className="h-12 px-7 bg-[#F26522] hover:bg-[#D64E0F] text-white font-black text-xs uppercase tracking-wider rounded-2xl transition-all active:scale-95 shadow-md shadow-[#F26522]/20 shrink-0"
            >
              Subscribe
            </button>
          </motion.form>
