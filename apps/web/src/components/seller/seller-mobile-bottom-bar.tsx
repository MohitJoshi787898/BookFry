...
export interface SellerMobileBottomBarProps {
  onOpenDrawer?: () => void;
}

export function SellerMobileBottomBar({ onOpenDrawer }: SellerMobileBottomBarProps) {
  const pathname = usePathname();

  const primaryTabs = [
    { name: 'Dashboard', href: '/seller/dashboard', icon: LayoutDashboard },
    { name: 'Leads', href: '/seller/requests', icon: MessageSquare },
    { name: 'Listings', href: '/seller/listings', icon: BookOpen },
          ...
          return (
            ...
            >
              <div className="relative">
                ...
                {isActive && (
                  <motion.div
                    layoutId="sellerBottomIndicator"
...
export default SellerMobileBottomBar;
