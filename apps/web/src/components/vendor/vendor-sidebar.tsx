...
const vendorNavGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { name: 'Products Catalog', href: '/vendor/products', icon: Package, badge: 'Catalog' },
      { name: 'Inventory & Stock', href: '/vendor/inventory', icon: Layers, badge: 'Alerts' },
      { name: 'Bulk Orders', href: '/vendor/orders', icon: ShoppingBag },
    ],
  },
  {
    title: 'Financials & Settings',
    items: [
      { name: 'Revenue & Settlements', href: '/vendor/revenue', icon: IndianRupee },
      { name: 'Business Analytics', href: '/vendor/analytics', icon: BarChart3 },
      { name: 'Vendor Settings', href: '/vendor/settings', icon: Settings },
    ],
  },
];

function VendorQuickActionsCard() {
  const actions = [
    { label: 'Add New Product', href: '/sell' },
    { label: 'Check Low Stock', href: '/vendor/inventory' },
    { label: 'Fulfill Orders', href: '/vendor/orders' },
    { label: 'View Revenue', href: '/vendor/revenue' },
  ];
    ...
    >
      <div className="relative flex h-full flex-col">
        ...
        <div className="flex-1 space-y-5 overflow-y-auto px-2.5 py-4">
          ...
          {!collapsed && <VendorQuickActionsCard />}
        </div>
