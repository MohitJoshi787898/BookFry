...
export function NewsletterSection({
  ...
  title = 'Stay in the Literary Loop',
  subtitle = 'Curated book picks, weekly discount drops, campus deal alerts, and early access to rare catalog additions. Zero spam, ever.',
  inputPlaceholder = 'your.email@college.edu',
  buttonLabel = 'Subscribe',
  disclaimer = 'By subscribing, you agree to our privacy policy. Unsubscribe anytime.',
  subscribedStat = '42,000+ students subscribed',
              ...
              <AnimatePresence mode="wait">
                {submitted ? (
                  ...
                  >
                    ...
                    <div>
                      <p className="font-extrabold text-sm text-primary-foreground">{successTitle}</p>
                      <p className="text-xs text-primary-foreground/60 mt-0.5">{successMessage}</p>
                    </div>
                  </motion.div>
                ) : (
                  <motion.form
