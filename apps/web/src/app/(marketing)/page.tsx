  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-text-primary transition-colors duration-200">
      ...
      <main className="flex-grow">
        ...
        <BookCarousel
          eyebrow="Trending Literature"
          title="Trending Reads"
          subtitle="The most discussed study guides, novels, and test prep materials"
        ...
        {/* 8. Top Rated Literature */}
        <BookCarousel
          eyebrow="Student Favorites"
          title="Top Rated Literature"
          subtitle="Highest rated books based on verified student reviews"
