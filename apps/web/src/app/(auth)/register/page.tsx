        ...
        <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 rounded-2xl border border-border bg-white overflow-hidden shadow-xs">
          ...
          <div className="bg-white p-8 flex flex-col justify-center space-y-6 font-sans">
            ...
            >
              ...
              {/* Terms checkbox */}
              <div className="pt-1">
                <label className="flex items-start space-x-2 cursor-pointer font-bold text-text-secondary leading-normal">
                  <input
                    type="checkbox"
                    required
                    className="mt-0.5 rounded border-border text-brand focus:ring-brand accent-[#F26522]"
                  />
